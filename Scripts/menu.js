...
var reducedWidth = 4;
var menuHoverHeight = 34;//height of hover effect
...
$(document).ready(function(){
	...
	$('.nav li').append('<div class="hover"><\/div>');
	   ...
	   $(".nav").css({width:"980px"});//setting total width of menu
	...
	$(".nav > li").hover(function(){
		...
		$(this).find('li').css({width:(width - reducedWidth * 2 - 1)+93});	
		if($.browser.opera){
			$(this).children('div').css("margin-top", "-10px");//opera padding fix
			
			}
		$(this).find('a:first').stop().animate({color:"#ffffff"},{duration:speed});//setting color of rollover effect
